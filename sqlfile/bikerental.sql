...
(1, 'admin', '5c428d8875d2948607f3e3fe134d71b4', '2024-06-24 12:22:38');
...
(1, 'Demo 1st Block 1st Cross, Riya nagar, Bangalore-560016																									', 'test@test.com', '9347201382');
...
Please read these Terms and Conditions ("Terms", "Terms and Conditions")  (the "Service") operated by Code Projects ("us", "we", or "our").
Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service.
By accessing or using the Service you agree to be bound by these Terms. If you disagree with any part of the terms then you may not access the Service. Terms and Conditions from TermsFeed for Projects. Your rental period begins when you unlock the bike and ends when you securely lock it at an approved location. Please ensure you plan your ride accordingly and return the bike on time.
...
(1, 'test@gmail.com', 'This is amazing! I mean really such great bike for rent at affordable price. oh this is crazy man!', '2024-06-18 07:44:31', 1),
(2, 'demo@gmail.com', '\nI think this is the one and only top bike rental site in the world. 5-Stars from me - Full satisfaction, no complain at all', '2024-06-18 07:46:05', 1);
...
(1, 'madhu sathya', 'demo@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '2147483647', NULL, NULL, NULL, NULL, '2024-06-24 19:59:27', '2024-06-26 21:02:58'),
(2, 'anu priya', 'anuj@gmail.com', 'f925916e2754e5e03f75dd58a5733251', '8285703354', NULL, NULL, NULL, NULL, '2024-06-24 20:00:49', '2024-06-26 21:03:09'),
(3, 'sharmi S', 'webhostingamigo@gmail.com', 'f09df7868d52e12bba658982dbd79821', '09999857868', '03/02/1990', 'PKL', 'PKL', 'PKL', '2024-06-24 20:01:43', '2024-06-24 21:07:41'),
(4, 'riya G', 'test@gmail.com', '5c428d8875d2948607f3e3fe134d71b4', '9999857868', '', 'PKL', 'XYZ', 'XYZ', '2024-06-24 20:03:36', '2024-06-26 19:18:14');
...
CREATE TABLE tblstaff (
 ...
 -- Add new columns
ALTER TABLE `tblusers` 
ADD COLUMN `account_no` VARCHAR(20) DEFAULT NULL,
...
-- Adjusting existing column definitions (if necessary)
ALTER TABLE `tblusers` 
MODIFY COLUMN `ContactNo` VARCHAR(15) DEFAULT NULL;

-- Setting the primary key if not already set
ALTER TABLE tbltestimonial
ADD COLUMN FeedbackType ENUM('bike', 'service') NOT NULL,
ADD COLUMN Rating INT(11) NOT NULL,
ADD COLUMN BikeName VARCHAR(100) DEFAULT NULL;


-- If AUTO_INCREMENT is not set
...
INSERT INTO `owner` (`id`, `UserName`, `Password`, `updationDate`) VALUES
(1, 'owner', '5c428d8875d2948607f3e3fe134d71b4', '2024-06-24 12:22:38');
