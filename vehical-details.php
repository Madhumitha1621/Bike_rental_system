    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p><i class="fa fa-inr" aria-hidden="true"></i><?php echo htmlentities($result->PricePerDay);?> </p>Per Day
...
<?php }} ?>
  ...
  <div class="share_vehicle">
    <p>Share: <a href="#"><i class="fa fa-facebook-square"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
  </div>
  <div class="sidebar_widget">
    ...
    <form method="post">
      <div class="form-group">
        <input type="text" class="form-control datetimepicker-input" id="fromdate" name="fromdate" placeholder="From Date(dd/mm/yyyy hh:mm)" required>
      </div>
      <div class="form-group">
        <input type="text" class="form-control datetimepicker-input" id="todate" name="todate" placeholder="To Date(dd/mm/yyyy hh:mm)" required>
      </div>
      <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    new tempusDominus.TempusDominus(document.getElementById('fromdate'), options);
    new tempusDominus.TempusDominus(document.getElementById('todate'), options);
  });
</script>
<script>
  $(document).ready(function(){
