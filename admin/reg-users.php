...
<head>
    ...
    <title>Bike Rental Portal |Admin Manage Register User</title>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-wrapper">
                                    ...
                                    <button id="generatePDF" class="btn btn-primary" style="margin-top: 20px;">Generate PDF</button>
                                </div>
                            </div>
                        </div>
                    </div>
